...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => scrollTo('finalcta')}
        className="ml-4 hidden md:inline-block px-5 py-2 bg-cyan-500 hover:bg-cyan-600 transition-all text-black font-semibold rounded-full shadow-[0_0_20px_rgba(0,255,255,0.2)] cursor-pointer"
      >
        Empezar ahora
      </button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="absolute top-full left-0 w-full bg-black/90 px-6 py-6 flex flex-col space-y-4 md:hidden"
          ...
          >
            ...
            <button
              onClick={() => scrollTo('finalcta')}
              className="mt-4 bg-cyan-500 hover:bg-cyan-600 text-black font-semibold px-5 py-2 rounded-full shadow-[0_0_20px_rgba(0,255,255,0.2)] cursor-pointer"
            >
              Empezar ahora
            </button>
          </motion.div>
